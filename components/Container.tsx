...
export default function Container(props) {
  ...
  const meta = {
    ...
    description: `
    Railroad signal profesional, Wayside, Crossing and PTC.`,
    image: 'https://morrisonj.com/static/images/banner.png',
    type: 'website',
    ...customMeta
  };
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://morrisonj.com${router.asPath}`}
        />
        <link rel="canonical" href={`https://morrisonj.com${router.asPath}`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Justin Morrison" />
